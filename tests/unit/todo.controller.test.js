...
const todoId = "6901d2ded00a98c7604bb216"
...
describe('TodoController.getTodoById', () => {
    ...
    it("should call TodoModel.findById with route parameters", async () => {
        req.params.todoId = "6901d2ded00a98c7604bb216";
        await TodoController.getTodoById(req, res, next);
        expect(TodoModel.findById).toHaveBeenCalledWith("6901d2ded00a98c7604bb216");
    });
